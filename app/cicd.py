...
sys.path.append("/bmi-calc/app/bmi-calc")
...
if "type_checking_functions" in RUN:
    ...
    process1 = Popen(["mypy", "/bmi-calc/app/bmi-calc/app/functions"])
    process1.wait()
...
if "type_checking_django" in RUN:
    ...
    print("------------------------------")
    process2 = Popen(["mypy", "/bmi-calc/app/bmi-calc/app/"])
    process2.wait()
...
if "unit_testing_all_but_git" in RUN:
    ...
    process3 = Popen(
        [
            ...
            "manage.py",
            "test",
            "--settings=bmi-calc.settings_tests",
            "--exclude-tag=git",
        ],
        cwd="/bmi-calc/app/bmi-calc/",
    )
