...
FILES_EXPECTED_ON_TEMPLATES_COPY = [
    "/bmi-calc/app/bmi-calc/app/tests/test_docs/mkdocs/docs/test_template1.md",
    "/bmi-calc/app/bmi-calc/app/tests/test_docs/mkdocs/docs/test_template2.md",
]
...
TEST_LINTER_SINGLE_FILE = {
    "/bmi-calc/app/bmi-calc/app/tests/test_docs/mkdocs_linter/good_files/good_file1.md": {
        "overal": "pass",
        "equal_brackets": "pass",
...
TEST_LINTER_FOLDER = {
    "/bmi-calc/app/bmi-calc/app/tests/test_docs/mkdocs_linter/good_files/good_file2.md": {
        "overal": "pass",
        "equal_brackets": "pass",
        "equal_double_brackets": "pass",
        "placeholder_in_front_matter": "pass",
...
TEST_LINTER_SINGLE_FILE_BAD = {
    "/bmi-calc/app/bmi-calc/app/tests/test_docs/mkdocs_linter/bad_files/bad_file1.md": {
        "overal": "fail",
        "equal_brackets": "fail",
...
TEST_LINTER_FOLDER_BAD = {
    ...
    "/bmi-calc/app/bmi-calc/app/tests/test_docs/mkdocs_linter/bad_files/bad_file2.md": {
        "overal": "fail",
        "equal_brackets": "pass",
        "equal_double_brackets": "pass",
